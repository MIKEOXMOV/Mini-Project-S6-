...
$conn = new PDO('mysql:host=localhost; dbname=project1', 'root', '') or die("An error occurred: Unable to connect to the database.");
...
<head>
    ...
    <style>
        ...
        .file_size {
            color: #777; /* Gray color for file size */
            font-size: 14px;
        }
    ...
    <?php while ($row = $query->fetch(PDO::FETCH_ASSOC)) : ?>
        <div class="file_item">
            ...
            <div class="file_details">
                <div class="file_name"><?php echo $row['name']; ?></div>
                
                <a href="download.php?filename=<?php echo $row['name']; ?>&f=<?php echo $row['fname']; ?>" class="download_link">
