...
// Fetch student's marks data and project details
$marks_query = "SELECT sm.attendance, gm.guide_marks, sm.project_report, sm.review1_total_marks, sm.review2_total_marks, sm.final_cie_mark,
                       u.name AS student_name, u.register_or_faculty_id, sg.group_id,
                       p.project_name, p.project_description
               FROM student_marks sm
               INNER JOIN users u ON sm.student_id = u.id
               LEFT JOIN student_groups sg ON sm.student_id = sg.student_id
...
// Check if student has marks and project details
        ...
        <?php if ($marks): ?>
            <div class="card">
                <div class="card-body">
                    ...
                    <p><strong>Project Name:</strong> <?php echo htmlspecialchars($marks['project_name']); ?></p>
                    <p><strong>Description:</strong> <?php echo htmlspecialchars($marks['project_description']); ?></p>
                </div>
            </div>
