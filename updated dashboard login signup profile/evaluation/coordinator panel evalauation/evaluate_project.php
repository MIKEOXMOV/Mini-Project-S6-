...
// Fetch students associated with the project and their group IDs
$students_query = "SELECT u.id, u.name, u.email, u.register_or_faculty_id, sg.group_id
                   FROM users u
                   INNER JOIN project_members pm ON u.id = pm.student_id
                ...
                <tbody>
                    ...
                    <?php while ($student = $students_result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo isset($student['group_id']) ? htmlspecialchars($student['group_id']) : 'Not Assigned'; ?></td>
                            <td>
