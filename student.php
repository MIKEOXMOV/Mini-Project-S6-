    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="http://localhost/my_php_project/prevproject.php">
        ...
        <div class="sidebar_profile flex">
            ...
            <div class="data_text">
               <!-- PHP code to display student's name -->
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div class="boxes">
                    <a href="http://localhost/my_php_project/prevproject.php">
                        <div class="box box1">
                            <i class="uil uil-comment-dots"></i>
                            <span class="text">CHAT</span>
                        </div>
                    </a>
                    <a href="http://localhost/my_php_project/showprevtable.php">
                        <div class="box box2">
                    ...
                    <a href="vidcall.html">
                        <div class="box box3">
                            <i justify="centre" class="uil uil-video"></i>
